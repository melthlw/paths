...
impl LibrariesData {
    ...
    pub fn default_icons() -> Vec<IconDef> {
        vec![
            ...
            IconDef { name: "Search".to_string(), icon_name: "search-symbolic".to_string(), path_data: String::new() },
            IconDef { name: "Settings".to_string(), icon_name: "prefs-general-symbolic".to_string(), path_data: String::new() },
            IconDef { name: "Favorite".to_string(), icon_name: "favorite-symbolic".to_string(), path_data: String::new() },
            IconDef { name: "Check".to_string(), icon_name: "check-symbolic".to_string(), path_data: String::new() },
            IconDef { name: "Close".to_string(), icon_name: "close-symbolic".to_string(), path_data: String::new() },
            ...
            IconDef { name: "Trash".to_string(), icon_name: "delete-symbolic".to_string(), path_data: String::new() },
            IconDef { name: "Edit".to_string(), icon_name: "edit-symbolic".to_string(), path_data: String::new() },
            ...
            IconDef { name: "Refresh".to_string(), icon_name: "reload-library-symbolic".to_string(), path_data: String::new() },
            ...
            IconDef { name: "Palette".to_string(), icon_name: "color-picker-symbolic".to_string(), path_data: String::new() },
            ...
            IconDef { name: "Lock".to_string(), icon_name: "lock-aspect-ratio-symbolic".to_string(), path_data: String::new() },
            IconDef { name: "Unlock".to_string(), icon_name: "unlock-aspect-ratio-symbolic".to_string(), path_data: String::new() },
            IconDef { name: "Info".to_string(), icon_name: "info-symbolic".to_string(), path_data: String::new() },
        ]
    }
